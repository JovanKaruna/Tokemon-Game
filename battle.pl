...
attack :-
	battle(2),
    multiplier(0),
	inbattle(X,_,_,Level),
	damage(X,RealDamageToEnemy),
	DamageToEnemy is RealDamageToEnemy + ((Level-1)*10),
	enemy(Y,EnemyHealth,MaxHealthEnemy,_),
...
attack :-
	...
	inbattle(X,_,_,Level),
	damage(X,RealDamageToEnemy),
	DamageToEnemy is RealDamageToEnemy * 3 / 2 + ((Level-1)*15),
	enemy(Y,EnemyHealth,MaxHealthEnemy,_),
	DamageToEnemy >= EnemyHealth,
	write(Y),write(' faints! Do you want to capture '),write(Y),
	write('?  (capture/0 to capture, otherwise move away.)'),nl,
...
attack :-
	...
	inbattle(X,_,_,Level),
	damage(X,RealDamageToEnemy),
	DamageToEnemy is RealDamageToEnemy / 2 + ((Level-1)*5),
	enemy(Y,EnemyHealth,MaxHealthEnemy,_),
	DamageToEnemy >= EnemyHealth,
	write(Y),write(' faints! Do you want to capture '),write(Y),
	write('?  (capture/0 to capture, otherwise move away.)'),nl,
